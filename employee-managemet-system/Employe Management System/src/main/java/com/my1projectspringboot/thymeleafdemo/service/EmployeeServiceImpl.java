...
import com.my1projectspringboot.thymeleafdemo.dao.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
	/*constructor injection to connect EmployeeRepository interface (data access object, second layer)
	with EmployeeServiceImpl class, third layer
	 */
